...
if __name__ == '__main__':
        ...
        for batch_id, data in enumerate(data_loader):
            ...
            if batch_id % 100 == 0:
                print("Epoch[{}/{}], Batch[{}/{}], batch_loss:{:.6f}".format(
                    epoch+1, epochs, batch_id+1, len(data_loader), loss.item()/batch_size))

        trainLoss.append(train_loss/i)
    ...
    plt.plot(x_label, trainLoss, c='blue', linestyle=':', label='train_loss')
    plt.legend(loc='upper right')
    plt.savefig(fname="trainLoss.png")